...
NEW_MOON_MOD=0 moon run --target native ./examples/quint-sync-recovery -- \
  "$local_trace"

set +e
local_negative="$(NEW_MOON_MOD=0 moon run --target native ./examples/quint-sync-recovery -- \
...
set +e
choreo_negative="$(NEW_MOON_MOD=0 moon run --target native ./examples/quint-sync-recovery -- \
