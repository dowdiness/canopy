/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.waku.jsonc` (hash: 0edebfc91ef617ed9f657678b8a524fe)
// Runtime types generated with workerd@1.20260722.1 2026-07-26 nodejs_compat
interface __BaseEnv_Env {
	WORKER_VERSION: WorkerVersionMetadata;
	ASSETS: Fetcher;
	SIGNALING: Fetcher /* crdt-signaling-server */;
}
