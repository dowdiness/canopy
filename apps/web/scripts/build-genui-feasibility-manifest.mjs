...
export async function buildManifest({
  ...
  return {
    ...
    validationCommands: [
      ...
      { id: 'typescript', command: 'npx', args: ['tsc', '--noEmit'], cwd: 'apps/web', env: {} },
      {
        id: 'development-e2e',
        command: 'npx',
      ...
      { id: 'production-build', command: 'npm', args: ['run', 'build'], cwd: 'apps/web', env: { NEW_MOON_MOD: '0' } },
      {
        id: 'production-e2e',
        command: 'npx',
        args: [
    ...
    journalPath: 'apps/web/test-results/genui-feasibility-live-v2/journal.jsonl',
    rawOutputPath: 'apps/web/test-results/genui-feasibility-live-v2/raw-slots.json',
