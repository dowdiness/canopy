# Project TODO — snapshot 2026-04-21

> **Frozen snapshot.** This is the full TODO list as it stood on 2026-04-21,
> kept for historical context. It includes every completed item with its
> shipping note. The current open backlog lives in
> [`docs/TODO.md`](../TODO.md).

Improvement proposals for Canopy — the incremental projectional editor with
CRDT collaboration. Items are grouped by area; completed items are kept with a
brief outcome so the history is self-describing.
...
| App | Purpose |
|-----|---------|
| `web/` | Canonical demo — vanilla JS, lambda + JSON + markdown editors |
| `demo-react/` | Collaborative demo — per-agent undo/redo, Alice/Bob sync |
